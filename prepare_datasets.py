...
if __name__ == '__main__':
   # construct_DetectionDataset(root_dir='/hdd1/kkokkobot/hanbat_data/01.데이터/원천데이터/MONO/A농장', tgt_dir='/hdd/kkokkobot/Detection_Data', train_ratio=0.8)
   construct_DetectionDataset(root_dir='/hdd1/kkokkobot/hanbat_data/01.데이터/원천데이터/MONO/A농장', tgt_dir='/hdd/kkokkobot/Detection_Data_tiny', train_ratio=0.8)
