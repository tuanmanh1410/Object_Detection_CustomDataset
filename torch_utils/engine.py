...
def valid_one_epoch(model, data_loader, device, epoch, val_loss_hist, print_freq):
    ...
    # Evaluate the model on the validation set to get mAP.
    model.eval()
    ...
    return metric_logger, batch_loss_list, stats
